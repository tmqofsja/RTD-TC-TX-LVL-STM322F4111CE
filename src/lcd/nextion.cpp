...
void lcdSetTemperatureDecimal(uint16_t val) {
  ...
  myNex.writeNum("home.ftemp1.val", val);
  myNex.writeNum("home.ftemp2.val", (uint16_t)val);
  myNex.writeNum("home.temp3.val", val);
  myNex.writeNum("home.temp4.val", val);
}
...
void lcdSettemp1(float val) {
  myNex.writeNum("sk.float1.val", val);
}

void lcdSettemp2(float val) {
  myNex.writeNum("sk.float2.val", val);
}
